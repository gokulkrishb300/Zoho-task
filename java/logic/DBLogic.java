...
public class DBLogic implements PersistenceLayer
{
	...
	{
		Account accountObj=getAccountDetails(customerID,accountId);
		
		amount=accountObj.getBankBalance()+amount;
		
		dataBase.updateRecord("update ACCOUNT set Balance=Balance +"+amount+" where AccountId="+ accountId +" CustomerID="+ customerID +";");
